...
export const QuoteList = (props: Omit<QuotesProps, 'sortIncludeGasFee'>) => {
  const { actionRef, onClose, payToken, receiveToken } = props;
  ...
  // Don't render if tokens aren't selected yet
  if (!payToken || !receiveToken || !show) return null;
