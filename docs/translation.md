...
If you want to verify that your translations are displayed correctly in Rampnow Wallet, follow the [local startup tutorial](/README.md#contribution) to start Rabby and switch to your language.
